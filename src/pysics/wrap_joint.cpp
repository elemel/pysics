...
namespace pysics {
    ...
    void wrap_revolute_joint()
    {
        class_<b2RevoluteJoint, bases<b2Joint> >("RevoluteJoint", no_init)
            ...
            .def("get_anchor_a", &b2RevoluteJoint::GetAnchorA)
            .def("get_anchor_b", &b2RevoluteJoint::GetAnchorB)
            .def("get_reaction_force", &b2RevoluteJoint::GetReactionForce)
            .def("get_reaction_torque", &b2RevoluteJoint::GetReactionTorque)
